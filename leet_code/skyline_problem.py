...
class Solution(object):
    ...
    def getSkyline(self, buildings):
        ...
        while i < n or len(liveHR) > 0:
            if len(liveHR) == 0 or (i < n and buildings[i][0] <= -liveHR[0][1]):
                x = buildings[i][0]
                #
                ...
                x = -liveHR[0][1]
                while len(liveHR) > 0 and -liveHR[0][1] <= x:
    ...
    # https://discuss.leetcode.com/topic/14987/108-ms-17-lines-body-explained/10
...
s = Solution()
print s.getSkyline_2(buildings)
